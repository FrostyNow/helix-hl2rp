LANGUAGE = {
	...
	ar1Desc = "A dark energy powered automatic carbine, Overwatch Standard Issue Pulse Carbine, OSIPC.",
	ar2Desc = "A dark energy powered automatic rifle, Overwatch Standard Issue Pulse Rifle, OSIPR.",
	...
	crowbarPryTip = "Pry the locked door.",
	crowbarPrying = "Prying...",
	crowbarPrySuccess = "You have successfully pried the door open.",
	crowbarPryFailed = "You failed to pry the door open.",
	crowbarLowStr = "You do not have enough strength to pry the door open.",
	crowbarBroken = "The crowbar has broken!",
	crowbarRepaired = "The crowbar has been repaired.",
	crowbarDurability = "Durability",
	...
	flareammoDesc = "A box contains %s flares for Flaregun.",
	akmMagazineDesc = "A steel magazine that holds %s rounds of 7.62×39mm ammunition.",
	pistolMagDesc = "A polymer magazine that holds %s rounds of 9×19mm Parabellum pistol ammunition.",
	smg1MagDesc = "A polymer magazine that holds %s rounds of 4.6×30mm ammunition.",
	buckshotDesc = "A buckshot shell.",
	stanagDesc = "A polymer magazine that holds %s rounds of 5.56×45mm ammunition.",
	...
	bookDesc = "A readable book.\nReading this can improve your intelligence.",
	cookBookDesc = "A readable book which is about cooking recipes and know-how.\nReading this can improve your cooking skill.",
	...
	shovelDesc = "A sturdy shovel. Can be used for farming or digging for scraps in dirt and sand.",
	shovelDurability = "Durability",
	shovelBroken = "The shovel has broken!",
	itemLotteryDesc = "A lottery ticket to earn tokens. Scratch it to see if you win anything.",
	itemLotteryUsedDesc = "A scratched lottery ticket. It's useless now.",
	lotteryScratch = "Scratch",
	lotteryScratchTip = "Scratch the ticket to see the result.",
	lotteryWonNotify = "You won! You can now redeem this ticket.",
	lotteryLostNotify = "You didn't win anything this time.",
	lotteryStatusWin = "Winner!",
	lotteryStatusLoss = "Better luck next time",
