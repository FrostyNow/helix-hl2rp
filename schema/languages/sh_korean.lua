LANGUAGE = {
	...
	["12.7mm HEI Round"] = "12.7mm 고폭소이탄",
	smg1grenadeammoDesc = "작은 구경이지만 작약을 채워 넣어 강력한 저지력으로 목표에 피해를 주는 폭발성 탄입니다.",
	["HEAB Round"] = "공중폭발 고폭탄",
	oicwgrenadeammoDesc = "공중에서 폭발하여 강력한 위력을 자랑하는 20mm 고폭유탄입니다.",
