LANGUAGE = {
	...
	supplementsDesc = "영양소는 빈약하지만 배를 채우는 데에는 제격입니다.\n\"계란맛\"",
	["Desiccated Sustenance Bar"] = "건조 양분 바",
	supplementsBarDesc = "살아남는 데 필요한 최소한의 영양소를 포함하는 딱딱한 블럭 형태의 바입니다. 잘못먹으면 이가 부러질지도...\n\"물맛\"",
	["Military-Grade Ration"] = "군용 등급 배급 포대",
	metropoliceRationDesc = "신체 능력을 향상시켜주는 고품질 음식이 들어 있습니다.",
	["Stimulated Protein Mix"] = "강화 단백질 믹스",
	metropoliceSupplementsDesc = "근력 강화와 일정량의 열량을 포함한 비뉴턴 액체 형태의 식품혼합물이 들어있습니다.\n\"연어맛\"",
	["Synthetized anti-fatigue bar"] = "합성 에너지 바",
	metropoliceRationbarDesc = "종합적인 신체적 피로를 해소하는데 효과적인 블럭 형태의 바입니다.\n\"바닐라맛\"",
	["Open"] = "열기",
	...
	["5V Battery"] = "5V 전지",
	item5vBatteryDesc = "5V 출력을 제공하는 일회용 전지입니다. 충전량이 남은 한 전기를 필요로 하는 장비에 사용할 수 있습니다.",
	["Bone"] = "뼈",
    ...
    ["Fertilizer"] = "비료",
    itemFertilizerDesc = "토양의 영양을 보충하여 농작물의 성장을 돕는 물질입니다.",
    ["Fiber optics"] = "광섬유",
