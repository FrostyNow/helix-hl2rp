...
ix.lang.AddTable("korean", {
	...
	["Vortigaunt Beam"] = "보르티곤트 빔",
	["Zap everything! Vortigaunt Style"] = "보르티곤트 스타일로 모든 것을 지져버리세요!",
	["Primary Fire: Vortigaunt zap.\nSecondary Fire: Target energy charging."] = "1차 공격: 보르티곤트 전격.\n2차 공격: 대상 에너지 충전.",
	
	-- Vortigaunt Heal weapon
	["Heal Ability"] = "치유 능력",
	["To heal others."] = "사람들을 치유합니다.",
	["Primary Fire: Heal"] = "1차 공격: 치유",
	
	-- Broom weapon
	Broom = "빗자루",
	["Primary Fire: Sweep\nSecondary Fire: Push/Knock"] = "1차 공격: 청소하기\\n2차 공격: 밀기/노크하기",
