...
LANGUAGE = {
	...
	["Scrap Lottery Box"] = "복권 상자 분해",
	recipeLotteryBoxDesc = "복권 상자를 찢어 종이로 만듭니다.",
	["Scrap Lottery Tickets"] = "복권 분해",
	recipeLotteryDesc = "복권 여러 장을 찢어 종이로 만듭니다.",
	["Scrap Empty Carton"] = "빈 우유갑 분해",
