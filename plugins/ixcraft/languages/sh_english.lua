...
LANGUAGE = {
	...
	["Combine Shield Scanner"] = "Combine Shield Scanner",
	recipeShieldScannerDesc = "Assemble some parts to craft a Combine Shield Scanner.",
	...
	recipeEmptyVialCraftDesc = "Assemble some parts to craft an empty vial.",
	...
	recipeScrapShieldScannerPartDesc = "Disassemble a shield scanner part to extract useful materials.",
	...
	recipeScrapLighterDesc = "Disassemble a lighter to extract plastic.",
	lighterNotEmpty = "You must use up all the lighter's fuel before disassembling it.",
	recipeScrapMatchDesc = "Disassemble a spent matchbox to extract paper.",
	matchNotEmpty = "You must use up all the matches before disassembling the box.",
