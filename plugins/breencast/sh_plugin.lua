...
ix.lang.AddTable("english", {
	...
	breenCastUseHint = "Use /breencast <welcome|instinct|collaboration|disruptor|overwatch> to start a set.",
	...
	breenCastUnknownSet = "Unknown Breencast set. Use welcome, instinct, collaboration, disruptor, overwatch, or false.",
...
ix.lang.AddTable("korean", {
	...
	breenCastUseHint = "/breencast <환영|본능|협조자|질서파괴|감시부대>로 세트를 시작하세요.",
	breenCastChatFormat = "브린 박사의 방송 \"%s\"",
	breenCastNoRelay = "서버에 브린캐스트 엔티티가 없습니다.",
	breenCastNoVoice = "브린캐스트는 ixvoice 플러그인이 필요합니다.",
	breenCastUnknownSet = "알 수 없는 브린캐스트 세트입니다. 환영, 본능, 협조자, 질서파괴, 감시부대, false 중 하나를 사용하세요.",
