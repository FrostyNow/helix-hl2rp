...
function PLUGIN:BuildCombinePayload(client, callback)
	...
	local payload = {
		...
		canEditObjectives = (client:IsAdmin() or hook.Run("CanPlayerEditObjectives", client) == true),
		canEditData = (client:IsAdmin() or client:IsCombine() or hook.Run("CanPlayerEditData", client, nil) == true),
