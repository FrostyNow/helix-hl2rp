...
PLUGIN.name = "Legs"
PLUGIN.author = "Valkyrie, blackops7799 | Modified by Frosty"
PLUGIN.description = "Renders the characters legs to the local player. Now supports Vortigaunts by Frosty!"
